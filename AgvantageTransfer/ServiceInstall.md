...
This command publishes the application in Release configuration for Windows x64 runtime as a self-contained single file, including native libraries for self-extraction.
Open commandline as an Administrator :
```cmd

        ...
        <ContentTemplate>
            ...
            <div style="font-size: small">
                <div>
                    ...
                    <asp:SqlDataSource runat="server" ID="sqlDaily" ConnectionString='<%$ ConnectionStrings:NW_DataConnectionString %>' SelectCommand="SELECT        Location, SUM(Finished) AS LoadsFinished, SUM(ABS(Intake)) AS IntakeLoads, SUM(ABS(Transfer)) AS TransferLoads, SUM(AtElev) AS LoadsAtElevator, SUM(ABS(NetIntake)) AS NetIntakeLbs, 
                         SUM(ABS(NetTransfer)) AS NetTransferLbs, SUM(ABS(NetIntake + NetTransfer)) AS TotalLbs, SUM(ABS(NetIntake / 60)) AS NetIntakeBushels, SUM(ABS(NetTransfer / 60)) AS NetTransferBushels, 
                         SUM(ABS((NetIntake + NetTransfer) / 60)) AS TotalNetBushels, Location_Id, Description

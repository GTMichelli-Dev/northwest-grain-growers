<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Variety_lots.aspx.cs" Inherits="Variety_lots" %>
            ...
            <div class="row col-md-12">
                ...
                <asp:GridView ID="GridView1" CssClass="table table-hover table-responsive  " HorizontalAlign="Center" runat="server" DataSourceID="sqlVarietyLots" AutoGenerateColumns="False" DataKeyNames="UID" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowSorting="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Variety" SortExpression="Variety_Description">
                            <EditItemTemplate>
                    ...
                    <div class="modal-body  ">
                        <div class="row">
                            ...
                            <div class=" col-md-6 ">
                                ...
                                <asp:SqlDataSource runat="server" ID="sqlCrop" ConnectionString='<%$ ConnectionStrings:NW_DataConnectionString %>' SelectCommand="SELECT '' AS text, NULL AS value UNION SELECT DISTINCT Crops.Description AS Text, Crops.UID AS value FROM Crops INNER JOIN Variety_Crop_Groups ON Crops.UID = Variety_Crop_Groups.Crop_UID WHERE (Crops.Use_At_Seed_Mill = 1) ORDER BY text"></asp:SqlDataSource>

...
namespace StreamScaleIP
{
...

    {
        ...
        public StreamingScale(string Scale_Description,string Address, int Port)
        {
            bool Exists = false;
        ...
        //
        public string ZeroCommand = "F130\r";
        ...
        public class ScaleData
        {
            ...
            public string RawWeightString
            {
                ...
                set 
                {
                    ...
                    {
                       if (WtArray[I].Contains("\r") && (WtArray[I].Length > 10))
                        {
                            int Wt;

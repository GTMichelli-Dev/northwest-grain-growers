...
require("ReqDebug")AppName="ADV375"SerialNumber=awtx.setupMenu.getSerialNumber()AWTX_LUA_UNDEFINED=0
AWTX_LUA_WEIGHT=1
AWTX_LUA_STRING=2
AWTX_LUA_DATE=3
AWTX_LUA_TIME=4
...
require("ReqScaleKeys")require("ReqTare")require("ReqSetpoint")require("ReqStats")require("ReqCheckWeigh")require("ReqBattery")require("ReqPLU")require("ReqAppMenu")function savePLUzero()plu.PLUTolLo=checkweigh.CheckTolLo

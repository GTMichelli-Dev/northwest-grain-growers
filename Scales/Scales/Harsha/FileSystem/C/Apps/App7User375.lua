...
--## DESC=This is the USER375 Checkmate App (App7User375.lua)

]]
require("ReqDebug")AppName="Cust 2"SerialNumber=awtx.setupMenu.getSerialNumber()AWTX_LUA_UNDEFINED=0
AWTX_LUA_WEIGHT=1
AWTX_LUA_STRING=2
AWTX_LUA_DATE=3
AWTX_LUA_TIME=4

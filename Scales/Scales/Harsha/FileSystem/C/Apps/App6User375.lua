...
--## DESC=This is the USER1375 Checkmate App (App6User375.lua)

]]
require("ReqDebug")AppName="Cust 1"SerialNumber=awtx.setupMenu.getSerialNumber()AWTX_LUA_UNDEFINED=0
AWTX_LUA_WEIGHT=1
AWTX_LUA_STRING=2
AWTX_LUA_DATE=3
AWTX_LUA_TIME=4
...
require("ReqScaleKeys")require("ReqTare")require("ReqSetpoint")require("ReqStats")require("ReqCheckWeigh")require("ReqBattery")require("ReqAppMenu")function awtx.keypad.KEY_SELECT_UP()if selectHoldFlag<HowManyRepeatsMakeAHold then

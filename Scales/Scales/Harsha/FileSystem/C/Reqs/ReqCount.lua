...
DB_FileLocation_AppConfig=[[C:\Database\AppConfig.db]]DB_FileLocation_AppData=[[C:\Database\AppData.db]]DB_FileLocation_Reports=[[C:\Reports]]..SerialNumber
end
...
awtx.weight.setAccum(counttable[channel].grossTotal,counttable[channel].netTotal,counttable[channel].countTotal,counttable[channel].transactionCount)end
end

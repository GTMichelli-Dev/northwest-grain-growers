...
sqlStr=string.format("UPDATE OR REPLACE tblCheckweighConfig SET value = '%f' WHERE varID = 'CheckTargHi'",checkweigh.CheckTargHi)else
sqlStr=string.format("UPDATE OR REPLACE tblCheckweighConfig SET value = '%f' WHERE varID = 'CheckTargHi'",checkweigh.CheckTargHi)end
result=dbFile:exec(sqlStr)dbFile:execute("COMMIT")dbFile:close()end
...
checkweigh.CheckTargLo=checkweigh.CheckTarg-(checkweigh.CheckTolLo)checkweigh.CheckTolHi=checkweigh.CheckOverDiv*wt.curDivision
...
function checkweigh.setUnitsOfMeasure(newUnits)awtx.weight.setCurrentUnits(newUnits)checkweigh.UnitsOfMeasureStr=wt.unitsStr
checkweigh.UnitsOfMeasure=wt.units

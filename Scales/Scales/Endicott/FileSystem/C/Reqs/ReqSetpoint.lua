...
setpoint.TargBasis="grossWtTotal"Output_Type_String={}Output_Prompt_String=""if system.modelStr=="ZM301"then
...
Matrix_Output_Type_String={}Matrix_Output_Type_String={[0]="Above_Below","Below_Above","Inside","Outside","Above_Below","Below_Above"}Matrix_Output_Prompt_String="ACT-Abv,ACT-Bel,ACT- IN,ACT-OUT,ACTAbv2,ACTBel2"local Input_Type_String={}local Input_Prompt_String
...
setpoint.setpt_above_below2=5
setpoint.setpt_below_above2=6
setpoint.setpt_checkweigh=7
...
function get_Mode_Model()if Setpointtable.OutputMode1==setpoint.setpt_above_below2 or Setpointtable.OutputMode1==setpoint.setpt_below_above2 then
return 2
elseif Setpointtable.OutputMode2==setpoint.setpt_above_below2 or Setpointtable.OutputMode2==setpoint.setpt_below_above2 then
return 2
elseif Setpointtable.OutputMode3==setpoint.setpt_above_below2 or Setpointtable.OutputMode3==setpoint.setpt_below_above2 then
return 2
elseif system.modelStr=="ZM301"then
return 0
...
return 1
elseif Setpointtable.OutputMode1==setpoint.setpt_above_below2 or Setpointtable.OutputMode1==setpoint.setpt_below_above2 then
return 1
else
return 0
end
...
newMode=3
elseif Setpointtable.OutputMode==setpoint.setpt_above_below2 then
newMode=4
elseif Setpointtable.OutputMode==setpoint.setpt_below_above2 then
newMode=5
end
...
Setpointtable.OutputMode=setpoint.setpt_above_below2
elseif newMode==5 then
Setpointtable.OutputMode=setpoint.setpt_below_above2
end
...
newMode=3
elseif Setpointtable.OutputMode1==setpoint.setpt_above_below2 then
newMode=4
elseif Setpointtable.OutputMode1==setpoint.setpt_below_above2 then
newMode=5
end
newMode,isEnterKey=awtx.keypad.selectList(Output_Prompt_String,newMode)awtx.display.writeLine(label)if isEnterKey then
if newMode==0 then
...
elseif newMode==4 then
Setpointtable.OutputMode1=setpoint.setpt_above_below2
elseif newMode==5 then
Setpointtable.OutputMode1=setpoint.setpt_below_above2
end
setpoint.extraStuffStore()else
end
end
...
newMode=3
elseif Setpointtable.OutputMode2==setpoint.setpt_above_below2 then
newMode=4
elseif Setpointtable.OutputMode2==setpoint.setpt_below_above2 then
newMode=5
end
newMode,isEnterKey=awtx.keypad.selectList(Output_Prompt_String,newMode)awtx.display.writeLine(label)if isEnterKey then
if newMode==0 then
...
elseif newMode==4 then
Setpointtable.OutputMode2=setpoint.setpt_above_below2
elseif newMode==5 then
Setpointtable.OutputMode2=setpoint.setpt_below_above2
end
setpoint.extraStuffStore()else
end
end
...
newMode=3
elseif Setpointtable.OutputMode3==setpoint.setpt_above_below2 then
newMode=4
elseif Setpointtable.OutputMode3==setpoint.setpt_below_above2 then
newMode=5
end
newMode,isEnterKey=awtx.keypad.selectList(Output_Prompt_String,newMode)awtx.display.writeLine(label)if isEnterKey then
if newMode==0 then
...
elseif newMode==4 then
Setpointtable.OutputMode3=setpoint.setpt_above_below2
elseif newMode==5 then
Setpointtable.OutputMode3=setpoint.setpt_below_above2
end
setpoint.extraStuffStore()else
end
end
...
local setpt1AboveBelow,setpt1BelowAbove,setpt1InsideOutside,setpt1OutsideInside,setpt1AboveBelow2,setpt1BelowAbove2
local setpt2AboveBelow,setpt2BelowAbove,setpt2InsideOutside,setpt2OutsideInside,setpt2AboveBelow2,setpt2BelowAbove2
local setpt3AboveBelow,setpt3BelowAbove,setpt3InsideOutside,setpt3OutsideInside,setpt3AboveBelow2,setpt3BelowAbove2
...
retVal,resultMsg=awtx.setPoint.set(1,setpt1OutsideInside)elseif(Setpointtable.OutputMode1==setpoint.setpt_above_below2)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1AboveBelow2)elseif(Setpointtable.OutputMode1==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1BelowAbove2)else
...
retVal,resultMsg=awtx.setPoint.set(2,setpt2OutsideInside)elseif(Setpointtable.OutputMode2==setpoint.setpt_above_below2)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2AboveBelow2)elseif(Setpointtable.OutputMode2==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2BelowAbove2)else
...
retVal,resultMsg=awtx.setPoint.set(3,setpt3OutsideInside)elseif(Setpointtable.OutputMode3==setpoint.setpt_above_below2)then
retVal,resultMsg=awtx.setPoint.set(3,setpt3AboveBelow2)elseif(Setpointtable.OutputMode3==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(3,setpt3BelowAbove2)else
...
elseif(cfg==setpoint.setpt_above_below2)then
if(Setpointtable.OutputMode1==setpoint.setpt_above_below)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1AboveBelow)elseif(Setpointtable.OutputMode1==setpoint.setpt_below_above)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1BelowAbove)elseif(Setpointtable.OutputMode1==setpoint.setpt_inside)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1InsideOutside)elseif(Setpointtable.OutputMode1==setpoint.setpt_outside)then
...
retVal,resultMsg=awtx.setPoint.set(1,setpt1AboveBelow2)elseif(Setpointtable.OutputMode1==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1BelowAbove2)else
retVal,resultMsg=awtx.setPoint.set(1,setpt1AboveBelow2)end
if(Setpointtable.OutputMode2==setpoint.setpt_above_below)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2AboveBelow)elseif(Setpointtable.OutputMode2==setpoint.setpt_below_above)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2BelowAbove)elseif(Setpointtable.OutputMode2==setpoint.setpt_inside)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2InsideOutside)elseif(Setpointtable.OutputMode2==setpoint.setpt_outside)then
...
retVal,resultMsg=awtx.setPoint.set(2,setpt2AboveBelow2)elseif(Setpointtable.OutputMode2==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2BelowAbove2)else
retVal,resultMsg=awtx.setPoint.set(2,setpt2AboveBelow2)end
if battery.BatteryEnable==1 then
retVal,resultMsg=awtx.setPoint.set(3,setPointBattery)else
if(Setpointtable.OutputMode3==setpoint.setpt_above_below)then
retVal,resultMsg=awtx.setPoint.set(3,setpt3AboveBelow)elseif(Setpointtable.OutputMode3==setpoint.setpt_below_above)then
...
retVal,resultMsg=awtx.setPoint.set(3,setpt3AboveBelow2)elseif(Setpointtable.OutputMode3==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(3,setpt3BelowAbove2)else
retVal,resultMsg=awtx.setPoint.set(3,setpt3AboveBelow2)end
end
elseif(cfg==setpoint.setpt_below_above2)then
if(Setpointtable.OutputMode1==setpoint.setpt_above_below)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1AboveBelow)elseif(Setpointtable.OutputMode1==setpoint.setpt_below_above)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1BelowAbove)elseif(Setpointtable.OutputMode1==setpoint.setpt_inside)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1InsideOutside)elseif(Setpointtable.OutputMode1==setpoint.setpt_outside)then
...
retVal,resultMsg=awtx.setPoint.set(1,setpt1AboveBelow2)elseif(Setpointtable.OutputMode1==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(1,setpt1BelowAbove2)else
retVal,resultMsg=awtx.setPoint.set(1,setpt1BelowAbove2)end
if(Setpointtable.OutputMode2==setpoint.setpt_above_below)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2AboveBelow)elseif(Setpointtable.OutputMode2==setpoint.setpt_below_above)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2BelowAbove)elseif(Setpointtable.OutputMode2==setpoint.setpt_inside)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2InsideOutside)elseif(Setpointtable.OutputMode2==setpoint.setpt_outside)then
...
retVal,resultMsg=awtx.setPoint.set(2,setpt2AboveBelow2)elseif(Setpointtable.OutputMode2==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(2,setpt2BelowAbove2)else
retVal,resultMsg=awtx.setPoint.set(2,setpt2BelowAbove2)end
if battery.BatteryEnable==1 then
retVal,resultMsg=awtx.setPoint.set(3,setPointBattery)else
if(Setpointtable.OutputMode3==setpoint.setpt_above_below)then
retVal,resultMsg=awtx.setPoint.set(3,setpt3AboveBelow)elseif(Setpointtable.OutputMode3==setpoint.setpt_below_above)then
...
retVal,resultMsg=awtx.setPoint.set(3,setpt3AboveBelow2)elseif(Setpointtable.OutputMode3==setpoint.setpt_below_above2)then
retVal,resultMsg=awtx.setPoint.set(3,setpt3BelowAbove2)else
retVal,resultMsg=awtx.setPoint.set(3,setpt3BelowAbove2)end
end

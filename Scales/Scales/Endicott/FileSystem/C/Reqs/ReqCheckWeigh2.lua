...
checkweigh.CheckTare=checkweigh.CheckTareDefault
...
checkweigh.CheckTare=plu.PLUTare
checkweigh.CheckMin=checkweigh.CheckMinDefault
checkweigh.CheckMax=checkweigh.CheckMaxDefault
else
checkweigh.CheckTargLo=awtx.weight.convertWeight(PLUWtUnit,plu.PLUTargLo,wt.units,1)checkweigh.CheckTargHi=awtx.weight.convertWeight(PLUWtUnit,plu.PLUTargHi,wt.units,1)checkweigh.CheckTolLo=awtx.weight.convertWeight(PLUWtUnit,plu.PLUTolLo,wt.units,1)checkweigh.CheckTolHi=awtx.weight.convertWeight(PLUWtUnit,plu.PLUTolHi,wt.units,1)checkweigh.CheckTarg=awtx.weight.convertWeight(PLUWtUnit,plu.PLUTarg,wt.units,1)checkweigh.CheckTare=awtx.weight.convertWeight(PLUWtUnit,plu.PLUTare,wt.units,1)checkweigh.CheckMin=checkweigh.CheckMinDefault
checkweigh.CheckMax=checkweigh.CheckMaxDefault
end
awtx.weight.requestPresetTare(checkweigh.CheckTare)if checkweigh.PackRunCnt==0 then

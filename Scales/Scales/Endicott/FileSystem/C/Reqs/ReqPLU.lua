...
currentRPN=awtx.keypad.get_RPN_mode()awtx.keypad.set_RPN_mode(0)awtx.display.writeLine("Busy")errorCode=awtx.os.convertCsvFileToTable_LUA(DB_FileLocation_AppData,"tblPLU",[[G:\PLU_CSV\plu.csv]])if errorCode==0 or errorCode==nil then
...
currentRPN=awtx.keypad.get_RPN_mode()awtx.keypad.set_RPN_mode(0)awtx.display.writeLine("Busy")errorCode=awtx.os.convertTableToCsvFile_LUA(DB_FileLocation_AppData,"tblPLU","plu.csv",[[G:\PLU_CSV]])if errorCode==0 or errorCode==nil then
awtx.display.writeLine("Done")else
awtx.display.writeLine(string.format("Err %2d",errorCode))end
awtx.os.sleep(1000)awtx.keypad.set_RPN_mode(currentRPN)end

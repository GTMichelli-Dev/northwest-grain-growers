...
--## DESC=This is the ADV375 Checkmate App (App3Adv375.lua)

]]
require("ReqDebug")AppName="ADV-2"SerialNumber=awtx.setupMenu.getSerialNumber()AWTX_LUA_UNDEFINED=0
AWTX_LUA_WEIGHT=1
AWTX_LUA_STRING=2
AWTX_LUA_DATE=3
AWTX_LUA_TIME=4
...
require("ReqScaleKeys")require("ReqTare")require("ReqSetpoint")require("ReqStats")require("ReqCheckWeigh2")require("ReqBattery")require("ReqPLU2")require("ReqAppMenu")function savePLUzero()plu.PLUTolLo=checkweigh.CheckTolLo
plu.PLUTolHi=checkweigh.CheckTolHi
plu.PLUTargLo=checkweigh.CheckTargLo
plu.PLUTargHi=checkweigh.CheckTargHi
plu.PLUTarg=checkweigh.CheckTarg
plu.PLUTare=checkweigh.CheckTare
plu.PLUunits=wt.unitsStr
plu.pluDBStore()end
...
displayPRNTOT()wt=awtx.weight.getRefreshLastPrint(1)awtx.printer.PrintFmt(checkweigh.TotalFmt)end
...
checkweigh.doTransactionWithPLU()plu.doPLUAccum()checkweigh.doPrintPopulate()if checkweigh.CheckStatPackage==2 then
checkweigh.doStatsPackage()end
wt=awtx.weight.getRefreshLastPrint(1)awtx.printer.PrintFmt(0)if checkweigh.StoreBeforePrint==false then
...
wt=awtx.weight.getCurrent(1)checkweigh.enterTolLo()savePLUzero()end
end
underHoldFlag=0
end

    ...
    <div class="form-row pb-2 ">
        <div class=" col-8   text-sm-center text-md-left ">
            <div class="btn-group-sm ">
                ...
                <div class="btn">
                    <asp:UpdatePanel runat="server" ID="pnlUpdatebtns" UpdateMode="Conditional">
                        <ContentTemplate>
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="tmrUPdateButtons" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
                <div class="btn">
                    ...
                    <asp:Panel runat="server" ID="pnlBagWeights" Width="100%" HorizontalAlign="Center">
                        <div class="col col-lg-8 p-0">
                            ...
                            <asp:Table runat="server" ID="tblBags" Width="100%" HorizontalAlign="Center" CssClass="table table-bordered table-sm table-hover table-striped  ">
                                ...
                                <asp:TableHeaderRow>
                                    <asp:TableHeaderCell Width="33%">Bag Count</asp:TableHeaderCell>
                                    <asp:TableHeaderCell Width="33%">Bag Size</asp:TableHeaderCell>
                                    <asp:TableHeaderCell Width="33%">Total Pounds</asp:TableHeaderCell>
                                </asp:TableHeaderRow>
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell CssClass="text-right">
                                        <div class=" input-group ">
                                            <asp:TextBox runat="server" ID="txtBagSize" OnTextChanged="txtBagSize_TextChanged" AutoPostBack="true" type="number" MaxLength="10" onkeypress="return isNumberKey(event)" Text="60" AutoCompleteType="Disabled" CssClass="form-control text-right  "></asp:TextBox>

                                            <div class="input-group-append ">
                                                <asp:DropDownList runat="server" ID="ddBagSizes" CssClass="input-group-text  text-right  font-weight-bold dropdown-right  " AutoPostBack="true" OnTextChanged="ddBagSize_TextChanged">

...
public partial class TicketCreator : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Auditing.LogMessage("TicketCreator.Page_Load", ex.Message);
    ...
    public void SetButtons()
    {
        ...
        btnSave.Visible = (!SeedTicketInfo.CurrentSeedTicketRow.ReadOnly && (SeedTicketInfo.seedTicketDataSet.Seed_Ticket_Varieties.Count > 0 || SeedTicketInfo.seedTicketDataSet.Seed_Ticket_Treatments.Count > 0 || SeedTicketInfo.seedTicketDataSet.Seed_Ticket_Weights.Count > 0));
        ...
        btnComplete.Visible = (!SeedTicketInfo.TicketComplete && (SeedTicketInfo.seedTicketDataSet.Seed_Ticket_Varieties.Count > 0 && WeightsComplete() && VarietiesComplete()));
    ...
    public void SetBagWeights()
    {
        ...
        ddBagSize.DataBind();
        ddBagSize.ClearSelection();
        if (SeedTicketInfo.CurrentSeedTicketRow.IsBag_CntNull()) SeedTicketInfo.CurrentSeedTicketRow.Bag_Cnt = 1;
        if (SeedTicketInfo.CurrentSeedTicketRow.IsBag_SizeNull()) SeedTicketInfo.CurrentSeedTicketRow.Bag_Size = int.Parse(ddBagSize.Items[0].Value);
        if (SeedTicketInfo.seedTicketDataSet.Seed_Ticket_Weights.Count == 0)
        {
    ...
    {
        SeedTicketInfo.CurrentSeedTicketRow.Bag_Size = int.Parse(ddBagSize.Text);
        SetBagWeights();
    }
    ...
    public void PrintTicket(Guid UID,int Copies=1)
    {
        ...
        {
            Response.Redirect($"~/PrintTicket?Compies={Copies}&UID={UID}");

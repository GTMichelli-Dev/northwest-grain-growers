...
public partial class TicketCreator : System.Web.UI.Page
{
    ...
    public void SetButtons()
    {
        ...
        ddNumberOfCopies.Visible = SeedTicketInfo.TicketComplete;
    ...
    public void PrintTicket(Guid UID)
    {
        ...
        {
            var numberOfTickets=int.Parse(ddNumberOfCopies.Text);
         //   Response.Redirect($"~/PrintTicket?Copies={numberOfTickets}&UID={UID}");
            Printing.Print_Ticket(UID, "", numberOfTickets);
        }
        else
        {
